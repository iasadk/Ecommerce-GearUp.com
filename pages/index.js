    ...
    <div className={styles.container}>
      ...
      <div className="mx-auto w-8/12 flex flex-col-reverse justify-center md:flex-row md:items-center md:justify-between mb-4 mt-8">
        ...
        <div className='object-cover w-full md:w-[40%] p-2 '>
          <img src="/hero-banner-img.png" alt="New arrivals" className='w-full object-cover' />
        </div>
      </div>
      <div className='mx-auto w-8/12 bg-emerald-100 flex flex-col justify-center items-center md:flex-row md:justify-between '>
        <div className='p-1'>
          <img src="/SHOP-IMG-1.png" alt="" className='hover:scale-105 transition-all delay-100 ease-in  hover:shadow-2xl hover:cursor-pointer' />
        ...
        <div className='mr-1 mt-3'>
          <img src="/SHOP-IMG-2.png" alt="" className='w-full hover:scale-105 transition-all delay-100 ease-in  hover:shadow-2xl hover:cursor-pointer' />
      ...
      <div className='mx-auto w-8/12 my-6 lg:mt-12'>
        ...
        <div className='grid grid-cols-1 gap-y-5 mt-5 md:grid-cols-2 md:gap-x-5 lg:grid-cols-3'>
          <img src="/equal-1.png" alt="equal" />
          <img src="/equal-2.png" alt="equal" />
          <img src="/equal-3.png" alt="equal" />
          <img src="/equal-4.png" alt="equal" />
          <img src="/equal-5.png" alt="equal" />
          <img src="/equal-6.png" alt="equal" />
        </div>
      </div>
